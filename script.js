...
let currentcharacter = 0; // Index for characters within a sentence
...
function PetScreen() {
  ...
  if (currentcharacter < fullTextArray[sentenceIndex].length) {
    // Add one character from the current sentence
    placeholder += fullTextArray[sentenceIndex].charAt(currentcharacter);
    ...
    currentcharacter = 0; // Reset character index for the next sentence
